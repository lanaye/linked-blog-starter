    ...
    <>
      ...
      <div className={'main-page06'}>
        ...
        <div className='flex gap-10 items-center justify-center mt-8'>
          ...
          {/* todo */}
          <div className={`text-lg w-[40%] ${adventProFont.className}`}>Одного дня у вашій свідомості промайнуло дивне послання, яке супроводжувалось різким головним болем, що руки автоматично почати тримати голову, щоб вона не розлетілась на друзки. І як тільки тіло почало звикати до цього болю мозок переключився на нове джерело - тепле, ледь обпікаюче, відчуття на долоні. Загадкова мітка якої же вчора не було - тепер красується у вас на долоні.

            Що це все означає? Чому саме ви? І чому та клята мітка не стирається? За вільним столом на вас чекають інші з такими ж мітками. </div>
        </div>
      </div>
