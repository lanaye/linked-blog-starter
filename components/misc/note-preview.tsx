...
const NotePreview = ({ title, content }: Props) => {
  return (
    <span className="note-preview block col-span-2 max-w-[400px] bg-gray-900 rounded shadow-sm p-5 cursor-pointer text-lg hover:bg-gray-800 hover:border-transparent">
